...
This work practically adapts Krahmer's borrowed code chunks technique<sup>[1]</sup> for modern x86-64 systems, building a ROP chain exploit that bypasses NX using return-to-libc attacks.
